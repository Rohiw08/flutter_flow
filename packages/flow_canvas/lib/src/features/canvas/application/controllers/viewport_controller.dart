...
class ViewportController {
  ...
  final ViewportCallbacks _viewportCallbacks;
  ...
  ViewportController({
    ...
    required ViewportCallbacks viewportCallbacks,
  })  : _controller = controller,
        _viewportService = viewportService,
        _coordinateConverter = coordinateConverter,
        _viewportStreams = viewportStreams,
        _viewportCallbacks = viewportCallbacks;
  ...
  void setViewportSize(Size size) {
    ...
    if (currentState.viewportSize != size) {
      ...
      _viewportCallbacks.onResize(event);
    }
  }
  ...
  void panBy(Offset delta) {
    ...
    _viewportStreams.emitEvent(event);
    _viewportCallbacks.onPan(event);
  }
  ...
  void fitView(
    ...
    _viewportStreams.emitEvent(event);
    _viewportCallbacks.onTransform(event);
  }
